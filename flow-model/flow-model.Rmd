...
The PCT's use of open source software enables others to create alternative scenarios, for example to represent the route network capacity implications of achieving local cycling targets and could facilitate its deployment in new cities and countries where origin-destination data is available.
