...
were the most computationally intensive part of the model.
...
By adding together the overlapping flows from multiple OD pairs a 'route network' of cycling potential can be created. As illustrated in Fig. XX, this can result in much higher estimates of cycling potential than the route-allocated OD data alone. Fix. XX shows the rate of cycling allong Otley Road rise from 73 to 296 based on a single OD pair but a much larger absolute rise of 301 to 1133 when all route-allocated OD pairs are considered.
...
The PCT is primarily based on OD data so the future scenarios also operate at this level.
It is important to emphasise that any model could be used to estimate the future update of cycling at this 'desire line' level and a wide range of scenarios could be developed and used in the PCT (further scenarios that could be developed are considered in the discussion).
This section outlines the scenarios used in the English version of the PCT.
...
A wide range of scenario-based or
