...
Cycling already provides fast, affordable,
...
policies worldwide^[Several examples
...
and the
proliferation of publicly subsidized 'bike share' schemes at the city level
[@OBrien2014a].^[An
...
As such, the question of where to construct new cycle infrastructure
is of strategic importance [@larsen_build_2013].
This creates the need
for new evidence-based tools focussed on active travel [@Payne2014],
contrasting the traditional 'predict and provide' paradigm [@na_ess_transport_2014].
Within this context the Propensity to Cycle Tool (PCT)
represents an open source and open access approach, in contrast to the
dominant paradigm in transport planning,
for evidence-based sustainable transport planning.
...
•	Estimation and visualisation of information at the zone and 'desire line' level, allowing the consideration of both area- and route-level potential.
•	Route-allocation of cycling 'desire lines' using origin destination data ('OD pairs'), enabling specific routes to be identified for improvement.
