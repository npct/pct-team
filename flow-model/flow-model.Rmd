...
Specifically, the PCT was designed to help decide where to prioritise new
infrastructure and policies locally for transport authorities operating at
city, region and country levels.
This paper describes the PCT and its application to case
...
the model. Using a model that estimates cycling potential as a function of route
distance,
hilliness and other factors at the OD and area level, multiple scenarios were
generated and interactively displayed using the PCT.
These included 'Gender Equality', in which women cycle
as much as men and 'Go Dutch', in which English people cycle as much as people in 
the Netherlands. The PCT is based entirely on open source software and is freely
available online at
[geo8.webarch.net/master/](http://geo8.webarch.net/master/). 
This open access and open source approach allows the PCT to be
...
cycling is the natural choice for short trips, as part of a wider
