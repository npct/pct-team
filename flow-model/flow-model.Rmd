...
This scenario was generated by taking baseline propensity to cycle (see previous section), and applying Dutch scaling factors calculated through analysis of the English and Dutch National Travel Surveys. The Go Dutch scaling factors comprised two parameters which boost the rate of cycling for each OD pair above the baseline model, with static and distant dependent terms to take into account the fact that the "Dutch multiplier" is greater for shorter trips compared to longer trips.
Note that the level of cycling under the Go Dutch scenario is unaffected by the current level of cycling.
...
cycles ('ebikes').
This scenario built on the Go Dutch scenario (described above) by applying three additional Ebike scaling factors to account for the increased willingness of Ebike users to cycle long distance, hilly and simultaneously long distance and hilly routes (see the Appendix, Equation 1B). These scaling factors were generated by analysing the impact of Ebike ownership based on the Swiss National Household Travel Survey and the Dutch National Travel Survey, weighted to be representative of English commuters.
