...
Reducing speed limits, creating car free zones and improving the urban realm have all be proposed to make places more cyclable, but the intervention that has received the most attention has been the construction of new cycle paths. Local authorities can clearly have a large influence on these paths, including their design (e.g. width) [@Heath2006;@TfL2014;@WG2014], directness  [@crow2007] and geographic location [@Aultman-Hall1997;@Minikel2012].
The PCT focusses on the last of these factors.

```{r, echo=FALSE}
# Traditional methods and tools transport planning, in the 'predict and provide' paradigm,
# and poorly suited to incorporate such factors into investment [@na_ess_transport_2014].
```
