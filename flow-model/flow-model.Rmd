...
this paper describes design, features and potential applications of such a tool.
...
There is often a tension between transparency and complexity in the design of tools for transport planning, and the latter can result in tools that are 'black boxes' [@saujot_making_2016].
...
We envision stakeholders with the capacity participating in the development of the tool, for example modifying scenarios for their own purposes, and academics adding new features and developing new use cases of the PCT.
Community-led enhancements could include:
