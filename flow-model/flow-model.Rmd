...
The flexibility of the PCT enables its use for many applications.
Because the underlying methods and computer code are open source,
enabling the PCT to be used as a basis for further work.
The project is available on [github.com/npct](https://github.com/npct),
making it easy for others to 'fork' and modify the code [see @lima2014coding].
This flexibility
