...
The results of traditional scenarios-based models of the future [e.g. @McCollum2009;@Lovelace2011c]
are typically not presented locally at area, let-alone route-specific levels.
PSS overcomes this issue using interactive maps.
...
[e.g. @Tamminga2012;@novosel2015agent;@waddell_urbansim_2002],
PSS offers the potential to tackle the issue that transport models tend to be
"closed to public over-sight"  [@golub_making_2013].
These considerations
influenced the design of the PCT.
