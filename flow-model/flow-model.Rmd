...
Specifically, the PCT uses origin-destination (OD) data to model the likely spatial distribution of new cycling routes.
...
cycling is the natural choice short trips, as part of a wider
sustainable mobility strategy and a key element in the
global transition towards low carbon, physically active transport.
...
whilst retain a relatively simple interface that is focussed on
...
(e.g. requiring sophisticated software from their interpretation)
...
To overcome these roadblocks, the
...
Future versions of the PCT could therefore help answer following question,
...
HEAT [@Fraser2011]. Geographically specific energy and
