...
specific process of related planning actions". Under this definition the PCT
is a PSS: it is systematic in its use of national data
...
It is worth briefly reviewing these in relation to the PCT.
Although PSS are primarily technical projects to *develop*, it has been found that 'soft' factors can impede their utility for practitioners.
...
These issues suggest that practitioners should be more involved in
the development of the software underlying PSS.
