...
In this context there is growing interest in investing in cycling infrastructure, including in countries
with historically low rates of cycling
[@buehler_bikeway_2016].^[Several examples
...
High-quality infrastructure can play a key role in cycling uptake [@parkin_cycling_2012].
Off-road cycle paths, for example, can help make cycling a safe, accessible and convenient
option for people of all ages and abilities [@heinen_changes_2015].
Further, modified cycles such as quadricycles and handcycles can enable independent mobility for disabled people [@aldred_transport:_2008], where appropriate infrastructure allows.
...
At the opposite end of the scale spectrum, @parkin_estimation_2008 created a regression model, operating at the level of wards, to estimate the proportion of commuter trips cycled across England and Wales.
