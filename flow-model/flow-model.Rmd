...
The four scenarios were developed to
explore cycling futures in England.
They are not intended to be predictions of the future but
snapshots that indicate how the spatial distribution of cycling is
likely to shift as cycling grows. The scenarios have also have an
order, ranging from near-term to longer term visions. They were: 
