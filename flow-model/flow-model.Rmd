...
creating the need for tools to visualise
the geographical distribution of future cycling potential.
This paper describes the Propensity to Cycle Tool (PCT), an
online, interactive support tool for visualising future cycling scenarios.
Specifically, the PCT
visualises where new cycling potential is greatest,
helping practitioners prioritise where new pro-cycling
infrastructure, investment and policies will have maximum effectiveness.
Case study cities in England are used to illustrate the tool's capabilities, which
uses origin-destination (OD) data to model future scenarios.
The model used in the case study estimates cycling potential as a function of route
distance, hilliness and other factors at the OD and area level, although more
sophisticated models could subsequently be used.
The most innovative feature of the PCT is its
interactive displayed of the shifting spatial distribution of cycling potential
under different scenarios.
In the case study these included 'Gender Equality' and 'Go Dutch',
although many other scenarios could be added, building
on the open source code-base. Critically, the PCT enables public
engagement in the transport modelling process, through its browser-based
interface:
[geo8.webarch.net/master/](http://geo8.webarch.net/master/). 
This approach allows the PCT to be
modified for use in new contexts without licensing or cost restrictions.
We conclude that the method can help plan for a future in which
cycling is the natural choice for intra-city trips, as part of a wider
