...
title: 'The Propensity to Cycle Tool: An open source online system for sustainable
  transport planning'
header-includes: \usepackage{amsmath} \usepackage{longtable} \usepackage{booktabs} \usepackage{setspace} \doublespacing
# documentclass: jtlu-article-2col
output:
  pdf_document:
    fig_caption: yes
    keep_tex: yes
...
The PCT is completely open source, enabling its rapid deployment new contexts, without cost or licensing restrictions.
We conclude that the approach can help plan for a future in which
cycling is the main mode for short urban journeys.
