...
It is important for interventions to happen in appropriate places, such as along
...
Scenarios including 'Go Dutch' and 'Ebikes' (which explored the impact of electrical cycles on cycling uptake) were developed and visualised for case study cities.
...
We conclude with a discussion of how new interactive and online tools such as the PCT could help make transport planning a more open and community-led process.
...
[@obrien_mining_2014].^[An
interactive web map associated with @obrien_mining_2014
...
new tools for assessing the best available evidence, and, by making the results
publicly available, encouraging informed debate.
The PCT thus supports the informed and open transport decision making
advocated [@golub_making_2013;@tamminga_design_2012].
Tools such as the PCT can inform the decision of where to construct
