...
can boost local cycling rates, when
constructed along
...
Case study cities in England illustrate the tool's capabilities under four scenarios, including 'Gender Equality' and 'Go Dutch', in which a dramatic increase in cycling is illustrated.
...
Its open source license enables its adaptation for new contexts.
We conclude that the open access and interactive approach to planning illustrated by the PCT can help design for cycling uptake at city, regional and national levels worldwide.
...
Furthermore, modified cycles, such as quadricycles and handcycles, can provide independence and mobility for disabled people [@Aldred2008], where appropriate infrastructure allows.
...
A flow diagram illustrating how the PCT is designed to be used (acknowledging it may have other uses) is presented in Figure 1.

```{r, echo=FALSE, fig.cap="Schematic diagram illustrating how the PCT was designed to be used."}
knitr::include_graphics("../figures/flow-diagram-uses.png")
```
