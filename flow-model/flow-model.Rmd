...
# writeLines(c(b1, b2), con = "references.bib")
...
Encouraging modal shift to cycling, as part of a wider sustainable mobility strategy, is an 
...
is an evidence-based support tool for deciding where to prioritise new
infrastructure and policies at
...
cycling is the natural choice for short trips, as
part of a wider global transition away from fossil fuels.
