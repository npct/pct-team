...
As outlined in the previous section much research has explored the impact of infrastructure on
cycling. The major challenge from a policy perspective is how to 'operationalise' this body of knowledge, to prioritise where to invest and in what. This research gap was described by
...
There is an emerging literature that seeks to explore related question of cycling potential, however. The link is clear: if one can identify which areas/routes/people have the highest potential, this can provide an evidence base about where to invest.
This work does not generally seek to provide systematic, quantitative or interactive evidence for transport planners. The methods broadly
...
A summary of tools and level at which they operate (in terms of data input and output) is presented in Table 1.
...
and a review of the state-of-the-art, @larsen_build_2013 created
...
of the areas that should be upgraded [@larsen_build_2013].

...

@Payne2014 used the concept of 'filtered permeability' to inform the commercially
developed Permeability Assessment Tool (PAT). 
The full methodology underlying the PAT have not been published but it does ...
... and....
