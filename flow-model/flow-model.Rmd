...
using OD data from the 2011 Census. The proportion of commutes by cycle was estimated as a function of route distance and hilliness using a logistic regression model operating at the individual level..
