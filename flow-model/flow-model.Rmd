...
Using origin-destination (OD) data, the PCT estimates where cycling has the greatest potential to grow.
Localised 'cycling futures' for commuter trips were generated as a function of route distance, hilliness and gender, and more sophisticated and context-specific 'back ends' are planned.
Central to the PCT's approach is the online browser-based user interface
(see [pct.bike](http://pct.bike/)) which is intended to
enable public participation in the transport planning process.
The open source license enables its adaptation for new contexts.
...
is of strategic importance [@larsen_build_2013].
There is increasing interest in evidence-based tools for active travel [@Payne2014] where
