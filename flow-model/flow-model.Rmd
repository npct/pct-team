...
Reducing speed limits, creating car free zones and improving the urban realm have all been proposed to make cycling more attractive [@parkin_planning_2015]. However, the intervention that has received the most attention has been the construction of new cycle paths. With devolved transport budgets, local and regional authorities can create and influence the design of strategic cycling networks. Design options include the width [@wegman_urban_1979;@pikora_developing_2002], quality [@Heath2006], directness  [@crow2007] and geographic location of the paths.
