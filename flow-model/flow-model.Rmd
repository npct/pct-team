...
The results of traditional scenario-based models of the future [@McCollum2009;@Lovelace2011c]
...
knitr::include_graphics("../figures/160229x8_NatModel_MSOA.pdf")
```
...
knitr::include_graphics("../figures/od-scens-leeds.png")
```
...
grid.raster(readPNG("../figures/man-trinity-way.png"))
```
...
Inspired by previous approaches to estimating cycling potential [@larsen_build_2013;@Zhang2014]
...
making it easy for others use the project as a basis for further work [@lima2014coding].
This flexibility
...
The scenarios suggest the PCT could be used for 'visioning' transport futures futures [@Tight2011].
...
- Use of alternative input data data, such as the location of new developments and road traffic speed and volumes. This work could build on recently developed GIS for transport planning [@Farrell_Weichenthal_Goldberg_Hatzopoulou_2015].
...
advocated [@golub_making_2013;@Tamminga2012].
