...
We conclude that the PCT provides insight into how new digital technologies could make planning a more open and community-led process for designing sustainable transport policies.
...
An evaluation of the PCT *after* it has been launched (July 2016) and used by practitioners will be needed to assess the extent to which the approach assists wil transport-land use planning.
This work will test our hypothesis that the tool could help setting local targets (by indicating what the potential is relative to other regions), supporting business cases (by showing that there is high cycling potential along proposed routes) and planning for capacity increases in cycling via the ambition Go Dutch and Ebike scenarios.
Above all, we believe the PCT will help design strategic cycling networks.

 determine the suitability of localised
