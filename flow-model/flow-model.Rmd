...
The PCT is an online planning support system funded by the UK's Department for Transport, the primary aim of which is to map where cycling potential is greatest, to optimise infrastructure investments and other cycling interventions (Department for Transport, 2015).
...
## Tools and methods for assessing cycling potential
...
Reducing speed limits, creating car free zones and improving the urban realm have all be proposed to make places more cyclable. However, the intervention that has received the most attention has been the construction of new cycle paths. With devolved transport budgets, local and regional authorities can create and influence the design of strategic cycling networks. Design options include the width [@wegman_urban_1979;@pikora_developing_2002], quality [@Heath2006;@TfL2014;@WG2014], directness  [@crow2007] and geographic location of the paths.
Much evidence and guidance has been produced about the design of cycle paths [e.g. @transport_for_london_london_2015]. Yet little work has explicitly tackled the question of where this high quality infrastructure should be built [see @Aultman-Hall1997;@Minikel2012].
...
Conventional transport planning tools within the 'predict and provide' paradigm [@naess_transport_2014] have limited capacity to inform the decision making process in relation to these issues. There has been a proliferation of research into the impact of infrastructure on
...
- Individual-based measures are based on individual level survey data, typically a household travel survey. These measures can help target specific groups, e.g. through tailored cycled training schemes.
...
course there is some overlap between the analysis of cycling potential at different levels and PSS. @Zhang2014, for example, is primarily focussed on cycling potential but could be used as the basis of a PSS. @Zhang2014 also use data from area, individual and route network levels although the analysis is primarily focussed the individual level of analysis and the route level of outputs.
]
