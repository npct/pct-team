...
This section describes and illustrates some outputs from the PCT, alongside discussion of how these outputs could be used in transport planning.  Note that some of the details of the graphics in the online version may evolve as the PCT develops.

## Model output tabs

Tabs are panels within the PCT, that reveal new information on the screen (see the top of Figure 3). Of these, the first four provide region-specific information:
