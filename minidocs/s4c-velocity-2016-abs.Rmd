...
some extent by the Propensity to Cycle Tool (go to www.pct.bike to test it out). ThePCT has been created using by an academic team funded by the UK's Department for
...
The panel session will be organized in 3 parts, each lasting 25 minutes.
In each there will be 10 minutes for panel presentations and 15 minutes for audience interaction. This will
ensure that the most important aspects of the question are covered:

1. What is the Propensity to Cycle Tool and how could it scale globally? This will focus on clarifying what the tool is, how it can be used and its potential to help plan for cycling in settlements and countries worldwide. It will touch on how the PCT differs existing tools for strategic cycle planning and its strengths, limitations and future potential. 

2. What is needed? This section will identify is missing from the current suite of tools for strategic cycle planning, and set out a ‘wishlist’ of tool features that participants and attendees most want to see.

3. How to move forward? This final section will address the question of how to
implement new, internationally scalable and open source tools for transport
planning. In it we will address the follow issues:
