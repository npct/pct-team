...
author: "Robin Lovelace (University Academic Fellow, Transport and Big Data)"
date: "`r Sys.Date()`"
output:
...
```
 ...
 - Now publised in the Journal of Transport and Land Use (JTLU) [@lovelace_propensity_2016]
...
**using established methods**. Often this difficulty relates to **size** but the form, format, and **complexity** are equally important"
[@lovelace_big_2016]. 
...
## This allows you to plot the route
...
See result on [rpubs](http://rpubs.com/RobinLovelace/254055)
or http://robinlovelace.net/figure/leeds-cam-data.html
...
# Implications for transport research

## Why transport research needs big data
...
```{r, echo=FALSE}
knitr::include_graphics("../figures/software-costs.png")
```
