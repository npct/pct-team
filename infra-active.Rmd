...
# Methodology
A method for assess each of the three types of active travel impact is outlined in this section in the abstract, such that it could be applied to any linear feature of interest. Then Section 4 provides specific examples using a case study of the Lewes-Uckfield train line.
...
## Identifying travel to public transport
...
The methodology used to identify these severance points consists of four stages:

- Subset desire lines that have both and origin and destination within 5km of a station/stop
- Remove lines that have the same stop as their closest origin and destination
- Create new desire lines that are from Origin to Station A and from Station B to destination
- Calculate change in cyclin potential along these new desire lines
