...
```{r lc, fig.cap="Overview of the Lewes-Uckfiled line with a 10 km buffer (blue). Width is proportional to the number of commutes, colour represents the proportion of people who cycle.", fig.height=8}
...
Only a few hundred commutes pass directly parallel to the route, mostly of medium distance from 10 to 20 km (route distance) between MSOAs in Lewes, Ringmer, and Uckfield. This implies that cycle paths running parallel to the train line itself have quite low commuter cycling potential.
...
```{r metafigure, echo=FALSE, fig.cap="The paralell, perpendicular and station access methods of subsetting desire lines affected by the new rail line."}
...
The cycling potential of the intersecting 'perpendicular' lines was then summed *per 1 km segment* of the rail line. The results, for the Government Target scenario, are presented in \@ref(fig:perpsel).
