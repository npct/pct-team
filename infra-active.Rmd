...
```{r type, echo=FALSE, fig.cap="A typology of active travel options."}
...
However, if the line were to be broken into segments, the results would resemble Figure \@ref(fig:segments).
...
The cycling potential of the intersecting 'perpendicular' lines was then summed *per 1 km segment* of the rail line. The results, for the Government Target scenario, are presented in \@ref(fig:perpagg).
