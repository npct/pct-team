...
if(file.exists(paste0("pct-data/", region, "/rf.Rds")) &
   file.exists(paste0("pct-data/", region, "/rq.Rds"))){
  ...
  saveRDS(rf, paste0("pct-data/", region, "/rf.Rds")) # save the routes
...
=======
>>>>>>> parent of 565ffb6... Updated sources links + %walk var added
