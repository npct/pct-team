...
if(file.exists(paste0("pct-bigdata/", region, "/rf.Rds")) &
   file.exists(paste0("pct-bigdata/", region, "/rq.Rds"))){
  rf <- readRDS(paste0("pct-bigdata/", region, "/rf.Rds")) # if you've loaded them
  rq <- readRDS(paste0("pct-bigdata/", region, "/rq.Rds"))
  # l <- readRDS(paste0("pct-bigdata/", region, "/l.Rds"))
  # nrow(rf) == nrow(l)
} else {
  ...
  saveRDS(rf, paste0("pct-bigdata/", region, "/rf.Rds")) # save the routes
  saveRDS(rq, paste0("pct-bigdata/", region, "/rq.Rds"))
}
...
rfoot <- round (100 * sum(l$Foot) / sum(l$All), 1)
...
file.copy("../pct-shiny/leeds/ui.R", paste0("../pct-shiny/", region, "/ui.R"))
