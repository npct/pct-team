...
- Task 5.1 Modify the PCT methodology to identify ‘parallels’ and ‘severance points’: 30 September 2016
- Task 5.2 Roll-out of a version of the PCT to highlight cycling opportunities raised by HS2: 30thNovember 2016
- Task 5.3 Case study of new railway line in Sussex: 30 September 2016

This document represents the delivery of Tasks 5.1 and 5.3 from the above list and will be used as a foundation to deliver Task 5.3 by 2016-11-30.
...
To identify parallels to linear features, a 4 stage methodology was developed:

- Subset cycling desire lines to include only those which pass in close proximity to the linear feature
- Break the linear feature of interest into segments of even distance
- Calculate the angle of the segments of the linear feature and desire lines
...
- Aggregate the cycling potential of all parallel lines per segment
...
The methodology used to identfy these severance points consists of 3 stages:

- Identify the desire lines which intersect with the impassable linear feature.
- Quantify the number of potential cyclists blocked along segments of the linear feature of even length
